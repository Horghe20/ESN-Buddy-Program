...
class EmailService:
    ...
    def send_reset_password_email(self, email, password):
        ...
        body = f"You requested a password reset. The following is your new password, use it for access and change the password:{password} If you did not request this, please access with this password and change it."
