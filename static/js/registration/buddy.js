...
function selectLanguage(language) {
    ...
    if (index === -1) {
        if (selectedLanguages.length < 3) {
            ...
            showModal('Validation Error','Please select at most 3 languages.');
        }
    } else {
...
function validateForm() {
    ...
    if (selectedLanguages.length == 0) {
        showModal('Validation Error','select at least 1 language and at most 3.');
        return false;
    }

    if (selectedInterests.length == 0) {
        showModal('Validation Error','Select at least 5 interest and at most 15');
        return false;
    }
