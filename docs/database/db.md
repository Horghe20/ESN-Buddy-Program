...
> Auto-generated documentation for [database.db](https://github.com/Horghe20/ESN-Buddy-Program/blob/master/database/db.py) module.
...
[Show source in db.py:21](https://github.com/Horghe20/ESN-Buddy-Program/blob/master/database/db.py#L21)
