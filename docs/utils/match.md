...
> Auto-generated documentation for [utils.match](https://github.com/Horghe20/ESN-Buddy-Program/blob/master/utils/match.py) module.
...
[Show source in match.py:31](https://github.com/Horghe20/ESN-Buddy-Program/blob/master/utils/match.py#L31)
...
- `esner` - An instance of the Esners model representing an ESN associate.
...
- [Esners](../database/tables.md#esners)



## match_making

[Show source in match.py:171](https://github.com/Horghe20/ESN-Buddy-Program/blob/master/utils/match.py#L171)
...
- `esners` - List of Esner instances.
